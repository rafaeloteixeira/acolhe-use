...
{
    public class ListaLinhasAdminPageViewModel : ViewModelBase
    {
        #region commands
        ...
        public ListaLinhasAdminPageViewModel(INavigationService navigationService, ILinhaRepository linhaRepository) :
