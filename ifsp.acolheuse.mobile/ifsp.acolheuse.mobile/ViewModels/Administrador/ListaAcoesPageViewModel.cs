...
namespace ifsp.acolheuse.mobile.ViewModels
{
    public class ListaAcoesPageViewModel : ViewModelBase
    {
        ...
        public ListaAcoesPageViewModel(INavigationService navigationService, ILinhaRepository linhaRepository, IAcaoRepository acaoRepository) :
        ...
        public async void BuscarAcoesCollectionAsync()
        {
            try
            {
                Linha.AcaoCollection = new ObservableCollection<Acao>();
