...
namespace ifsp.acolheuse.mobile.ViewModels
{
    public class MenuAdminPageViewModel : ViewModelBase
    {
        ...
        public async void NavegarMenu(int Id)
        {
            ...
            {
                case 0:
                    await navigationService.NavigateAsync("ListaServidoresAdminPage");
                    break;
                case 1:
                    await navigationService.NavigateAsync("ListaLinhasAdminPage");
                    break;
                case 2:
                    await navigationService.NavigateAsync("ListaAcoesAdminPage");
                    break;
                case 3:
                    await navigationService.NavigateAsync("ListaEstagiariosAdminPage");
                    break;
                case 4:
                    await navigationService.NavigateAsync("ListaUsuariosAdminPage");
                    break;
                case 5:
