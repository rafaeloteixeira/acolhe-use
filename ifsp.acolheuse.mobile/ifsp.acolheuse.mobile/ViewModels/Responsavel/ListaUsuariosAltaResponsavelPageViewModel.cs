...
{
    public class ListaUsuariosAltaResponsavelPageViewModel : ViewModelBase
    {
        #region commands
        ...
        public ListaUsuariosAltaResponsavelPageViewModel(INavigationService navigationService, IServidorRepository servidorRepository, IAcaoRepository acaoRepository, IPacienteRepository pacienteRepository) :
