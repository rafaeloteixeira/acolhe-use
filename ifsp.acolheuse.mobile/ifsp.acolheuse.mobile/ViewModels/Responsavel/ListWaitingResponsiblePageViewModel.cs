...
{
    public class ListWaitingResponsiblePageViewModel : ViewModelBase
    {
        #region commands
        ...
        public ListWaitingResponsiblePageViewModel(INavigationService navigationService, IResponsibleRepository responsibleRepository, IActionRepository actionRepository, IPatientRepository patientRepository) :
