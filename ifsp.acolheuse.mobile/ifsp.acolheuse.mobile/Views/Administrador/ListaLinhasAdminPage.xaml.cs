...
{
    public partial class ListaLinhasAdminPage : ContentPage
    {
        private readonly ViewModels.Administrador.ListaLinhasAdminPageViewModel _viewModel;
        public ListaLinhasAdminPage()
        {
            InitializeComponent();
            _viewModel = BindingContext as ViewModels.Administrador.ListaLinhasAdminPageViewModel;
