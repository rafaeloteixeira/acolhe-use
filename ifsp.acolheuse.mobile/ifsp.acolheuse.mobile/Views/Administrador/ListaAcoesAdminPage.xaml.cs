...
{
    public partial class ListaAcoesAdminPage : ContentPage
    {
        private readonly ViewModels.Administrador.ListaAcoesAdminPageViewModel _viewModel;
        public ListaAcoesAdminPage()
        {
            InitializeComponent();
            _viewModel = BindingContext as ViewModels.Administrador.ListaAcoesAdminPageViewModel;
