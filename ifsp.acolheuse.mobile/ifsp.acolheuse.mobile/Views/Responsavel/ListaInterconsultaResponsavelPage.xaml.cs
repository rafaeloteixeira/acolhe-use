...
{
    public partial class ListaInterconsultaResponsavelPage : ContentPage
    {
        private readonly ListaInterconsultaResponsavelPageViewModel _viewModel;
        public ListaInterconsultaResponsavelPage()
        {
            InitializeComponent();
            _viewModel = BindingContext as ListaInterconsultaResponsavelPageViewModel;
        }
